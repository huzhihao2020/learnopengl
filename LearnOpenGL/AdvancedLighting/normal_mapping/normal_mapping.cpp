...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL-normal_mapping", NULL, NULL);
    if(window == NULL) {
    ...
    // create shader
    Shader shader("/Users/lance/code/learnopengl/LearnOpenGL/AdvancedLighting/normal_mapping/normal_mapping.vs", "/Users/lance/code/learnopengl/LearnOpenGL/AdvancedLighting/normal_mapping/normal_mapping.fs");
    ...
    unsigned int plane_texture = loadTexture("/Users/lance/code/learnopengl/LearnOpenGL/assets/textures/brickwall.jpg");
    unsigned int normal_map = loadTexture("/Users/lance/code/learnopengl/LearnOpenGL/assets/textures/brickwall_normal.jpg");
