...
int main() {
    ...
    std::string VertesShaderPath1 = FolderPath + "/5.Light.Color.colors.vs";
    std::string FragmentShaderPath1 = FolderPath + "/5.Light.Color.colors.fs";
    std::string VertesShaderPath2 = FolderPath + "/5.Light.Color.light_cube.vs";
    std::string FragmentShaderPath2 = FolderPath + "/5.Light.Color.light_cube.fs";
...
//            ImGui::Checkbox("Another Window", &show_another_window);
            ...
            if (ImGui::Button("Button"))                            // true when clicked
                counter++;
            ImGui::SameLine();
