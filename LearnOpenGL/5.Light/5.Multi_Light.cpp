...
int main() {
    ...
    std::string VertesShaderPath1 = FolderPath + "/5.Multi_Light.vs";
    std::string FragmentShaderPath1 = FolderPath + "/5.Multi_Light.fs";
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        static bool isLightOn[3] = {true, true, true};
        {
            // ImguiBegin
            ...
            ImGui::Checkbox("dirLight", &isLightOn[0]);
            ImGui::Checkbox("pointLight", &isLightOn[1]);
            ImGui::Checkbox("spotLight", &isLightOn[2]);
        ...
        lightingShader.setBool("isLightOn[0]", isLightOn[0]);
        lightingShader.setBool("isLightOn[1]", isLightOn[1]);
        lightingShader.setBool("isLightOn[2]", isLightOn[2]);
