...
std::string VertesShaderPath   = FolderPath + "/4.Camera-3.3.shader.vs";
std::string FragmentShaderPath = FolderPath + "/4.Camera-3.3.shader.fs";
...
int main()
{
    ...
    // init vertex&fragment shader from files
    ...
    // pos0:position attribute, pos1:texture coord
    ...
    ourShader.use(); // 设置uniform变量需要激活shader
