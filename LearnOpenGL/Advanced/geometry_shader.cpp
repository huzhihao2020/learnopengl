...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "geometry_shader", NULL, NULL);
    if(window == NULL) {
    ...
    Shader shader("/Users/lance/code/learnopengl/LearnOpenGL/Advanced/geometry_shader.vs", "/Users/lance/code/learnopengl/LearnOpenGL/Advanced/geometry_shader.fs", "/Users/lance/code/learnopengl/LearnOpenGL/Advanced/geometry_shader.gs");
...
//    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::Begin("geometry_shader"); // Create a window
        ...
        shader.use();
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(-0.25f, 0.25f, 0.0f)); // move top-left
