...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "geometry_shader_explode", NULL, NULL);
    if(window == NULL) {
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::Begin("geometry_shader_explode"); // Create a window
        ...
        backpack_shader.use();
        backpack_shader.setFloat("time", currentFrame);
        model = glm::mat4(1.0f);
