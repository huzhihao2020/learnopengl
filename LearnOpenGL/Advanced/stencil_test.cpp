...
int main() {
    ...
    // create shader
    Shader shader("/Users/lance/code/learnopengl/LearnOpenGL/Advanced/stencil_test.vs", "/Users/lance/code/learnopengl/LearnOpenGL/Advanced/stencil_test.fs");
    Shader single_color_shader("/Users/lance/code/learnopengl/LearnOpenGL/Advanced/stencil_test.vs", "/Users/lance/code/learnopengl/LearnOpenGL/Advanced/stencil_test_single_color.fs");
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::Begin("stencil test!"); // Create a window
        ...
        shader.setMat4("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36); // cube1
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
        shader.setMat4("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36); // cube2
        //draw cubes single color
