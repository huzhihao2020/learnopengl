...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL-Anti-Aliasing", NULL, NULL);
    if(window == NULL) {
    ...
    // create shader
    Shader shader("/Users/lance/code/learnopengl/LearnOpenGL/Advanced/anti-aliasing.vs", "/Users/lance/code/learnopengl/LearnOpenGL/Advanced/anti-aliasing.fs");
